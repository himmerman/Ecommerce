...
$route['our-products'] = 'products/index';
$route['thank-you'] = 'products/thankYou';

$route['product/(:any)'] = 'products/viewProduct/$1';
$route['shopping-cart'] = 'products/viewCart';
$route['check-out'] = 'products/checkOut';

$route['administrator'] = 'main/admin';
